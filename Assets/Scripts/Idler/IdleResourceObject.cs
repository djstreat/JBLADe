...
namespace Idler
{
    public class IdleResourceObject : MonoBehaviour
    {
        ...
        [SerializeField] private int workerCost = 0;
        ...
        {
            return resourceCount > workerCost;
        }

        public void BuyWorker()
        {
            if (CanBuyWorker()) resourceCount -= workerCost;
        }
        ...
        private void OnTriggerEnter2D(Collider2D other)
        {
            ...
            if (other.CompareTag("Worker"))
            {
                ...
                if (worker.headHome == false) worker.ToggleTarget(); // Switches direction
            }
        }
    }
}
